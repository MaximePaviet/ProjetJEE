...
<h1>CYSCOLARITÉ</h1>
<div class="container">
    <a href="/views/Teacher/ConnexionTeacher" class="button">Enseignants</a>
    <a href="/views/Student/ConnexionStudent" class="button">Étudiants</a>
    <a href="/views/Administrator/ConnexionAdministrator" class="button">Administrateur</a>
</div>
</body>
</html>
