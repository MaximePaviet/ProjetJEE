...
<h1>Page cours</h1>
<div class="container">
  <form id="searchForm" action="${pageContext.request.contextPath}/CoursePageAdminController" method="GET">
  <div class="searchBar">
    <span>🔍︎</span>
    <input type="text"
           name="search"
...
<table id="studentsTable">
  ...
  <tbody>
    ...
    com.projetjee.projetjeespringboot.models.Teacher courseTeacher = course.getTeacher();
%>
    <tr>
