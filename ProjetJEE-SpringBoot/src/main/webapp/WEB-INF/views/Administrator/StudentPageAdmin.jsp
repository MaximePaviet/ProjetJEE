...
<div class="container">
  <form id="searchForm" action="${pageContext.request.contextPath}/StudentPageAdminController" method="GET">
    <div class="searchBar">
      <span>🔍︎</span>
      <input
              type="text"
...
<table id="studentsTable">
  ...
  <tr onclick="viewProfile(<%=student.getIdStudent()%>)" class="studentRow" data-promo="<%= student.getSchoolYear() %>">
...
<script>
  ...
  function deleteStudent(idStudent) {
    if (idStudent) {
      ...
      const form = document.createElement("form");
      form.method = "POST";
      form.action = `${pageContext.request.contextPath}/DeleteStudentAdminController`;
      // Ajoutez un champ caché contenant l'ID de l'enseignant
      const input = document.createElement("input");
      input.type = "hidden";
      input.name = "idStudent";
